...
export default {
    ...
    list(params: DiarySearchParams): Promise<{success: boolean, data: Array<DiaryEntityFromServer>, message: string}>  { return request('get'   , params, null, 'diary/list')}  ,
    ...
    detail(params: {diaryId: number}): Promise<{success: boolean, data: DiaryEntityFromServer, message: string}>{ return request('get',    params,null, 'diary/detail')},
    share(params: {diaryId: number}): Promise<{success: boolean, data: DiaryEntityFromServer, message: string}> { return request('get',    params, null,'diary/share')},
